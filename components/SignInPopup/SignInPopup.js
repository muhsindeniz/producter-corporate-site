...
const WaitListPopup = (props) => {
    ...
    if (!showSignInPopup || router.asPath !== "/#signin")
        return <></>
    return (<>
        {
            !loaded && <img
        ...
        {
            loaded && <div className={style.container}>
                <div className={style.card_container}>
                    <div className={style.closeButton} onClick={() => { router.push('/', undefined, { shallow: true }); setShowSignInPopup(false); document.body.style.overflow = "scroll" }}>
                    ...
                    <div className={style.section}>
                        <div className={style.headerContainer}>
                            ...
                            <div className={style.inputSection}>
                                <input value={workspace} placeholder='workspacename' className={style.inputContainer} onChange={(e) => setWorkspace(e.target.value)}></input>
